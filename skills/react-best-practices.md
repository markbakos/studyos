...
description: React and Next.js performance optimization guidelines from Vercel Engineering. Use when writing, reviewing, or refactoring React code, implementing data fetching, optimizing bundles, or improving rendering performance.
license: MIT
metadata:
  author: vercel
  version: "1.0.0"
